...
const getFormElements = () => ({
    ...
    balanceDiv: document.getElementById('balance') as HTMLDivElement,
    incomeDiv: document.getElementById('total-income') as HTMLDivElement,
    expenseDiv: document.getElementById('total-expense') as HTMLDivElement,
    listDiv: document.getElementById('transactions-list') as HTMLDivElement
});

const updateCategoryOptions = (type: 'Income' | 'Expense'): void => {
...
const resetForm = (): void => {
    ...
    updateCategoryOptions(type.value as 'Income' | 'Expense');
    amount.value = '';
...
export const initializeForm = (): void => {
    ...
    type.addEventListener('change', (e) => 
        updateCategoryOptions((e.target as HTMLSelectElement).value as 'Income' | 'Expense')
    );
    ...
    createBtn.addEventListener('click', () => {
        ...
        if (editingId) {
            updateTransaction(editingId, type.value as 'Income' | 'Expense', category.value, amountValue, date.value);
        } else {
            addTransaction(type.value as 'Income' | 'Expense', category.value, amountValue, date.value);
        }
    ...
    (window as any).deleteTransactionConfirm = (id: string) => {
